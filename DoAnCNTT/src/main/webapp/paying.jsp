                     ...
                     <tr class="first-row">
                         <td>
                             ...
                             <div class="input-row row mt-2">
                                 ...
                                 <div class="col  ">
                                     <input class="form-control" type="text" name="tenthe" id="tenthe" placeholder="Ví dụ: NGUYEN VAN A" pattern="[A-Z\s]+" required>
                                     <span style="color: red; float: left;">*</span>
                                     <small class="form-text text-muted">Nhập tên in hoa không dấu</small>
                                 </div>
                             </div>
                         </td>
                         <td>
                     ...
                     <tr>
                         <td>
                             ...
                             <div class="input-row row mt-2">
                                 ...
                                 <div class="col  ">
                                     <input class="form-control" type="text" name="mabaomat" id="mabaomat" placeholder="Ví dụ: 123" pattern="[0-9]{3,4}" maxlength="4" required>
                                     <span style="color: red; float: left;">*</span>
                                     <small class="form-text text-muted">Nhập 3-4 chữ số</small>
                                 </div>
                             </div>
